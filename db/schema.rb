...
ActiveRecord::Schema.define(:version => 20131249145251) do
  ...
  create_table "refinery_volume_translations", :force => true do |t|
    t.integer  "refinery_volume_id"
    t.string   "locale",             :null => false
    t.datetime "created_at",         :null => false
    t.datetime "updated_at",         :null => false
    t.string   "price"
  ...
  add_index "refinery_volume_translations", ["locale"], :name => "index_refinery_volume_translations_on_locale"
  add_index "refinery_volume_translations", ["refinery_volume_id"], :name => "index_refinery_volume_translations_on_refinery_volume_id"

  create_table "refinery_volumes", :force => true do |t|
    t.string   "price"
    t.string   "volume"
    t.integer  "pic_id"
    t.integer  "position"
