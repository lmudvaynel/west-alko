      ...
      describe "products" do
        ...
        describe "create" do
          ...
          context "duplicate" do
            before { FactoryGirl.create(:product, :name => "UniqueTitle") }
          ...
          context "with translations" do
            ...
            describe "add a page with title for default locale" do
              ...
              it "should show locale flag for page" do
                p = Refinery::Products::Product.last
            ...
            describe "add a product with title for primary and secondary locale" do
              ...
              it "should succeed" do
                Refinery::Products::Product.count.should == 1
                Refinery::Products::Product::Translation.count.should == 2
              end
        ...
        describe "edit" do
          before { FactoryGirl.create(:product, :name => "A name") }
        ...
        describe "destroy" do
          before { FactoryGirl.create(:product, :name => "UniqueTitleOne") }
